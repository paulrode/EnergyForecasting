...
setAs("character","myDate", function(from) mdy(from))
utility_bills <- fread("C:/Users/paulr/Documents/R/EnergyForecasting/data/MASTER METERING DATA.csv", colClasses = c("character", "character","character","myDate", "myDate", "integer", "numeric", "character","numeric", "character"))

utility_bills <- replace_na(utility_bills, list(Demand = 0)) 

utility_bills[, Period:= (utility_bills$`Start Date`) - (utility_bills$`End Date`)]
str(utility_bills)
utility_bills["Demand" %like% "N/A",]
