...
CoolingDD2019 <- fread("C:/Users/paulr/Documents/R/EnergyForecasting/data/ClimateDivisions.Cooling2020.txt") 
...
CoolingDD2021 <- fread("C:/Users/paulr/Documents/R/EnergyForecasting/data/ClimateDivisions.Cooling2020.txt") 
CoolingDD2021[Region == 3004,] -> CoolingDD2021
CoolingDD2021[,!(1), with = FALSE] -> CoolingDD2021
names <- colnames(CoolingDD2021)
CoolingDD2021 <- melt(CoolingDD2021, measure.vars = names, variable.name = "week")
CoolingDD2021 <- CoolingDD2021[, week := ymd(week)] 

rbind(CoolingDD2018, CoolingDD2019, CoolingDD2020, CoolingDD2021) -> CoolingDD
...
HeatingDD2019 <- fread("C:/Users/paulr/Documents/R/EnergyForecasting/data/ClimateDivisions.Heating2020.txt") 
HeatingDD2019[Region == 3004,] -> CoolingDD2019
HeatingDD2019[,!(1), with = FALSE] -> CoolingDD2019
...
HeatingDD2021 <- fread("C:/Users/paulr/Documents/R/EnergyForecasting/data/ClimateDivisions.Cooling2020.txt") 
HeatingDD2021[Region == 3004,] -> HeatingDD2021
HeatingDD2021[,!(1), with = FALSE] -> HeatingDD2021
names <- colnames(HeatingDD2021)
HeatingDD2021 <- melt(HeatingDD2021, measure.vars = names, variable.name = "week")
HeatingDD2021 <- HeatingDD2021[, week := ymd(week)] 

rbind(HeatingDD2018, HeatingDD2019, HeatingDD2020, HeatingDD2021) -> HeatingDD
