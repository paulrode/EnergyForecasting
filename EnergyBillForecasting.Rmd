...
lmDaily <- lm(summer$Value ~ summer$CDD, data = summer)
summary(lmDaily)

ggplot(data = summer, aes(x = CDD, y = Value)) +
  geom_point() +
  geom_smooth()

ggplot(data = summer, aes(x = ymdDate, y = Value)) +
  geom_line() +
  geom_smooth()
...
ggplot(data = Daily[year(week) == 2019 & month(week) == c(6,7,8) & wday(week) == c(2,3,4,5,6), ] , aes(x = CDD, y = DayValue)) +
  geom_point() +
  geom_smooth()

ggplot(data = Daily[year(week) == 2019 & month(week) == c(1,2,3,12) & wday(week) == c(2,3,4,5,6), ] , aes(x = HDD, y = DayValue)) +
  geom_point() +
  geom_smooth()

ggplot(data = Electric_Data[year(Date) == 2019 & month(Date) == c(3,6),], aes(Date, Value)) +
  geom_line()
...
ggplot(Electric_Data[year(Date) == 2019 & month(Date) == 6,], aes(Date,Value)) +
  geom_line() +
  geom_line(aes(x = Date, y = MinValue), color="blue") +
  geom_line(aes(x = Date, y = MaxValue), color="red")
